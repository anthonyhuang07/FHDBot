...
client.on('ready', () => {
    ...
    client.user.setActivity(`RETIRED - NO LONGER MAINTAINED`, { type: '', url: "https://www.twitch.tv/fhdhgngn" })
})
//#endregion
//#region (bot invited)
...
let stackedCountries, guessStreak = {
    highscore: 0,
    record: ""
}
...
client.on('messageCreate', (message) => {
    ...
    if(command === `${config.prefix}help` || message.content === `<@963533621812158474>`){
        ...
        .setDescription('The help menu for FHDBot. (No longer maintained)')
        ...
        .setTimestamp()
        .setFooter({ text: 'FHDBot - This bot is no longer maintained! No new bug fixes and commands will happen anymore.', iconURL: 'https://i.imgur.com/mU0RScm.png' });
